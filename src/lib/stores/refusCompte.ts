...
const REFUS = {
  ...
  refus_utilisateur: "compte.refus.refus_utilisateur",
  delai_depasse: "compte.refus.delai_depasse",
  identite_refusee: "compte.refus.identite_refusee",
  google_non_configure: "compte.refus.serveur",
  navigateur_indisponible: "compte.refus.navigateur_indisponible",
  ecoute_impossible: "compte.refus.serveur",
  reponse_inattendue: "compte.refus.serveur",
  reponse_illisible: "compte.refus.serveur",
  echange_refuse: "compte.refus.identite_refusee",
  alea_indisponible: "compte.refus.serveur",
